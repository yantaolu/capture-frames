...
在 Chrome 工具栏右键点击扩展图标并进入“选项”，可以：

- 点击“启用推荐视频网站”，授权爱奇艺、优酷、腾讯视频、哔哩哔哩及 B 站直播。
- 输入自定义网站地址并逐站授权。
- 从列表移除网站并撤销对应访问权限。

自动模式会静默等待页面中的视频出现，检测到视频后才显示控制条。新增或移除网站后，需要刷新已经打开的目标网站页面。
